...
describe('Sidebar', () => {
  it('renders all three agents', () => {
    render(<Sidebar agents={mockAgents} activeAgentId={null} onSelectAgent={() => {}} />);
  ...
  it('calls onSelectAgent when an agent card is clicked', async () => {
    ...
    render(<Sidebar agents={mockAgents} activeAgentId={null} onSelectAgent={handleSelect} />);
  ...
  it('passes activeAgentId to the correct card', () => {
    const { container } = render(
      <Sidebar agents={mockAgents} activeAgentId="cfo" onSelectAgent={() => {}} />
    );
  ...
  it('renders an empty sidebar when no agents provided', () => {
    render(<Sidebar agents={[]} activeAgentId={null} onSelectAgent={() => {}} />);
